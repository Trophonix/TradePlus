...
public class TradePlus extends JavaPlugin {
  ...
  @Getter private boolean excessChest;
  @Getter private String excessTitle;
  ...
  private void loadConfig() {
    ...
    if (!configFile.exists()) {
      ...
      if (configVersion < 1.2) {
        ...
        config.set(
            "economy.offer", "&7Your current money offer is &3&l%MONEYAMOUNT% %CURRENCYNAME%");
        config.set(
            "economy.theiroffer",
            "&7Their current money offer is &3&l%MONEYAMOUNT% %CURRENCYNAME%");
        config.set(
            "economy.higher",
            "&a&lClick to raise your money offer by %MONEYAMOUNT% %CURRENCYNAME%");
        config.set(
      ...
      if (configVersion < 1.34) {
        ...
        config.set(
            ...
            config.getString(
                "economy.theiroffer", "&7Their current money offer is &e%MONEYAMOUNT%"));
      ...
      if (configVersion < 2.1) {
        ...
        config.set("extras.playerpoints.material", "diamond");
        config.set(
            "extras.playerpoints.display", "&7Your current PlayerPoints offer is &b%AMOUNT%");
        config.set(
      ...
      if (configVersion < 2.52) {
        ...
        config.set("extras.tokenenchant.material", "enchanted_book");
        config.set(
            "extras.tokenenchant.display",
            "&7Your current TokenEnchant tokens offer is &b%AMOUNT%");
        config.set(
            "extras.tokenenchant.theirdisplay",
      ...
      if (configVersion < 3.15) {
        ...
        config.set("extras.tokenmanager.material", "emerald");
        config.set(
            "extras.tokenmanager.display",
            "&7Your current TokenManager tokens offer is &b%AMOUNT%");
        config.set(
            "extras.tokenmanager.theirdisplay",
      ...
      if (configVersion < 3.71) {
        if (!config.getString("extras.experience.theirdisplay", "&aTheir current XP offer is &2%AMOUNT%").contains("%LEVELS%")) {
