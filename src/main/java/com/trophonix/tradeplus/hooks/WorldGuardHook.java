...
public class WorldGuardHook {
  ...
  public static void init() {
    tradingFlag = WorldGuardWrapper.getInstance().registerFlag("trading", Boolean.TYPE, true).orElse(WorldGuardWrapper.getInstance().getFlag("trading", Boolean.TYPE).orElse(null));
  }
